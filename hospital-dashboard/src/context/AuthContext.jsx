...
const mockUsers = {
  ...
  nurse: { id: 5, name: 'Nurse Clara Johnson', email: 'nurse@curepulse.com', role: 'nurse', department: 'General Ward', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ClaraJohnson' }
};
...
export function AuthProvider({ children }) {
  ...
  const signup = useCallback((userData) => {
    ...
    if (newUser.role === 'nurse') {
      newUser.department = 'General Ward';
    }
